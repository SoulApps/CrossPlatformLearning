...
public class J2SEFacade implements J2SEFacadeDelegate {
	...
	public static void main(String[] args) {
		...
		variableLocal = "cuenta1: "+cuenta1.getSaldo()+"\nCuenta2: "+cuenta2.getSaldo();
