...
public class Padre {
    ...
    private String privadoPadre = "Privado Padre";
    protected String protegidoPadre = "Protegido Padre";
    public String publicoPadre = "Público Padre";
    String amigablePadre = "Amigable Padre";
}
