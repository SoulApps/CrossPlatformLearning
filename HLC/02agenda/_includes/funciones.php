...
function comprobar_msg(){
    ...
    */
    if(isset($_SESSION['msg'])){
        ...
        $_SESSION['msg']= 0;
        return  "<span style='display:block;'> Debes introducir usuario y contreseña.</span>";
        ...
        return  "<span style='display:block;'> Usuario {$_GET['n']} no disponible.</span>";
            ...
            $_SESSION['msg']= 0;
        return  "<span style='display:block;'> Problemas en el servidor intentalo en 5'</span>";
